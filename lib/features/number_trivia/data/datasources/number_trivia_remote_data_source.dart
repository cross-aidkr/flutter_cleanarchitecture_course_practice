...
class NumberTriviaRemoteDataSourceImpl implements NumberTriviaRemoteDataSource{
  ...
  @override
  Future<NumberTriviaModel> getConcreteNumberTrivia(int number) => _getTriviaFromUrl(Uri.http('numbersapi.com', '/$number'));

  @override
  Future<NumberTriviaModel> getRandomNumberTrivia() => _getTriviaFromUrl(Uri.http('numbersapi.com', '/random'));
